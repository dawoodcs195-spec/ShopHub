        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="max-w-4xl w-full grid lg:grid-cols-2 shadow-soft-lg rounded-xl overflow-hidden">
                ...
                <motion.div 
                    ...
                    transition={{ duration: 0.7, ease: "easeOut" }}
                >
                    <h2 className="font-serif text-4xl font-bold text-text-primary mb-4">Join Our Community</h2>
                    <p className="text-text-secondary">
                        Become a part of our creative world and start your collection of beautiful, handcrafted art.
                    </p>
                </motion.div>
            </div>
        </div>
