      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <Reveal y={14} duration={0.8}>
            <div className="relative overflow-hidden text-center rounded-[36px] border border-border dark:border-dark-border bg-card dark:bg-dark-card shadow-soft max-w-2xl mx-auto p-12 sm:p-14">
              ...
              <div className="relative">
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-50 to-amber-50 dark:from-dark-accent/35 dark:to-dark-secondary/35 text-[#B76E79] shadow-sm">
                ...
                <p className="mt-4 text-text-secondary dark:text-dark-muted-foreground leading-8">
                  ...
                  Your favorites will stay right here, waiting.
                </p>
