    ...
    <div className="min-h-screen bg-background dark:bg-dark-background">
      <div className="max-w-7xl mx-auto p-4 sm:p-8">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-card-foreground dark:text-dark-card-foreground">
            Reports
          </h1>
        ...
        <div className="mt-8">
          {loading ? (
            <div className="bg-secondary dark:bg-dark-secondary border border-black/5 dark:border-white/10 p-8 rounded-xl shadow-soft text-center text-muted-foreground dark:text-dark-muted-foreground">
