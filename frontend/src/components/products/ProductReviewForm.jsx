  ...
  return (
    <div className="bg-card dark:bg-dark-card border border-border dark:border-dark-border rounded-xl shadow-md p-6 sm:p-8 mt-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className="font-semibold text-card-foreground dark:text-dark-card-foreground block mb-2">
            Your Rating
          </label>
        ...
        <div>
          <label
            htmlFor="comment"
            className="font-semibold text-card-foreground dark:text-dark-card-foreground block mb-2"
          >
            Your Comment
          </label>
          <textarea
