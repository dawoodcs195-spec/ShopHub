...
const MeetArtist = () => {
  ...
  return (
    <section
      id="story"
      ref={sectionRef}
      className="scroll-mt-24 relative overflow-hidden bg-background dark:bg-dark-background py-16 sm:py-20 lg:py-28"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 grid items-center gap-10 sm:gap-14 lg:gap-16 lg:grid-cols-2">
          <Reveal y={22} duration={0.85} className="relative">
            <div className="absolute inset-0 rounded-[28px] sm:rounded-[36px] bg-gradient-to-br from-rose-100/40 to-amber-100/40 dark:from-dark-accent/45 dark:to-dark-secondary/45 blur-2xl scale-95" />
            ...
            >
              ...
              <figcaption className="absolute bottom-0 left-0 right-0 z-10">
                <div className="bg-gradient-to-t from-black/55 via-black/20 to-transparent px-5 sm:px-8 py-5 sm:py-6">
          ...
          <Reveal y={22} duration={0.85} delay={0.05}>
            <div>
              ...
              <p className="mt-5 sm:mt-8 text-base sm:text-lg leading-8 sm:leading-9 text-text-secondary dark:text-dark-muted-foreground">
              ...
              <p className="mt-5 sm:mt-8 text-base sm:text-lg leading-8 sm:leading-9 text-text-secondary dark:text-dark-muted-foreground">
                ...
                and attention to detail as the very first piece.
              </p>

              <div className="mt-8 sm:mt-10 rounded-3xl border-l-4 border-[#B76E79] bg-accent/40 dark:bg-dark-accent/45 p-5 sm:p-6">
                <p className="font-serif text-xl sm:text-2xl italic text-text-primary dark:text-dark-card-foreground">
        ...
        <Reveal y={18} duration={0.8} className="mt-12 sm:mt-16 lg:mt-24">
          <div className="grid gap-5 sm:gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {values.map((item) => (
              <motion.div
                ...
                className="rounded-3xl border border-border dark:border-dark-border bg-card dark:bg-dark-card p-6 sm:p-8 shadow-soft transition-shadow duration-300 hover:shadow-xl"
              >
                <div className="mb-4 sm:mb-5 h-1.5 w-12 rounded-full bg-[#B76E79]/70" />
                <h3 className="font-serif text-xl sm:text-2xl font-semibold text-text-primary dark:text-dark-card-foreground">
                  {item.title}
                </h3>
