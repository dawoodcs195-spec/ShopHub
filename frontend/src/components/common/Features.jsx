...
const Features = () => {
  return (
    <section className="relative overflow-hidden bg-background dark:bg-dark-background py-24">
            ...
            {features.map((feature) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className="group rounded-[30px] border border-border dark:border-dark-border bg-card dark:bg-dark-card p-8 shadow-soft transition-all duration-500 hover:shadow-2xl"
                >
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FDF1F3] to-[#FFF7ED] dark:from-dark-accent/60 dark:to-dark-secondary/60 text-[#B76E79] shadow-sm transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110">
                    <Icon className="text-3xl" />
                  </div>

                  <h3 className="mt-8 font-serif text-2xl font-semibold text-text-primary dark:text-dark-card-foreground">
                    {feature.title}
                  </h3>

                  <p className="mt-5 leading-8 text-text-secondary dark:text-dark-muted-foreground">
                    {feature.description}
                  </p>
